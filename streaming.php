...
if (isset($getEpisode['error'])) {
    header('Location: https://animein.fun/home');
}
;
                                ...
                                <div class="watch-player">
                                    <div class="player-frame">
                                        ...
                                        <iframe name="iframe-to-load"
                                            src="https://animein.fun/player2/v6.php/<?php echo $url?>" frameborder="0"
                                            scrolling="no"
                                ...
                                <div class="player-servers">
                                    <div id="servers-content">
                                        ...
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            ...
                                            <div class="ps__-list">
                                                <div class="item">
                                                    <a id="server1" href="https://animein.fun/player2/v6.php/<?php echo $url?>"
                                                        target="iframe-to-load" class="btn btn-server active">Vidcdn</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2"
                                                        href="https://animein.fun/player2/v6.php/<?php echo $url?>"
