...
<body>
    ...
    <script>
        ...
        jwplayer('codenine_player').setup({
            ...
            logo: {
                file: "https://media.discordapp.net/attachments/1101594912543228048/1130279190785175653/mangaTales.png?width=820&height=130",
                position: "top-right",
                link: "#",
            },
            skin: {
        ...
        var playerContainer = document.getElementById("codenine_player");
        ...
        document.getElementById("custom-menu-item-1").addEventListener("click", function () {
            alert("Custom Menu Item 1 clicked!");
            hideCustomMenu();
        });

        document.getElementById("custom-menu-item-2").addEventListener("click", function () {
